...
<body>
    ...
    <div class="content">
        <div class="bg-white rounded shadow p-4 p-md-5">
            <h3 class="text-warning mb-4"><i class="bi bi-dash-circle"></i> Stok Keluar</h3>
            ...
            <form action="{{ route('admin.stok.keluar') }}" method="POST">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="keterangan" rows="3" class="form-control" placeholder="Contoh: Rusak / Kadaluarsa"></textarea>
                    </div>
                </div>

                <div class="mt-4">
                    <button type="submit" class="btn btn-warning btn-lg"><i class="bi bi-check-lg"></i> Kurangi Stok</button>

...
<div class="flex min-h-screen">
    ...
    <div class="flex-1 flex flex-col min-w-0">
        ...
        <header class="fixed-header bg-white shadow-lg px-6 py-4 flex items-center justify-between md:hidden">
            ...
            <h1 class="text-xl font-bold text-green-700">Stok Masuk</h1>
            <div class="w-10"></div>
        </header>
        ...
        <main class="main-content flex-1 p-6 md:p-8 lg:p-10">
            ...
            <div class="mb-8">
                <h3 class="text-3xl md:text-4xl font-bold text-green-700 flex items-center gap-4">
                    <i class="ph ph-arrow-down text-6xl md:text-6xl"></i>
                    Tambah Stok Masuk
                </h3>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-2xl p-6 md:p-10">
                <form action="{{ route('admin.stok.masuk') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <!-- Jumlah Masuk -->
                        <div>
                            <label class="block text-gray-700 font-medium mb-medium mb-2">
                                <i class="ph ph-plus-circle text-xl mr-2"></i> Jumlah Masuk
                            </label>

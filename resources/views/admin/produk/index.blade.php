                        ...
                        <tbody class="divide-y divide-gray-100">
                            @forelse($produks as $p)
                                <tr class="hover:bg-gray-50 transition duration-200">
                                    <!-- FOTO – SUDAH SESUAI DENGAN LARAVEL STORAGE -->
                                    <td class="py-4 px-3">
                                        @if($p->foto)
                                        ...
                                        @else
                                            <div class="w-14 h-14 bg-gray-200 border-2 border-dashed border-gray-400 rounded-lg flex items-center justify-center">
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-20">
                                        <div class="text-gray-400">
                                            ...
                                            <p class="text-2xl font-medium">Belum ada produk terdaftar</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse

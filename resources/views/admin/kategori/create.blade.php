...
<head>
    ...
    <title>Tambah Kategori - POS Admin</title>
        ...
        <main class="flex-1 p-6 md:p-8 lg:p-10 overflow-y-auto bg-gray-50">
            ...
            <div class="mb-8 mt-20">
                <h3 class="text-3xl md:text-4xl font-bold text-blue-700 flex items-center gap-4 mb-2">
                    <i class="ph ph-plus-circle text-5xl md:text-6xl"></i>
                    Tambah Kategori Baru
                </h3>
                <p class="text-gray-600 text-lg">Isi formulir di bawah untuk menambahkan kategori produk</p>
            </div>

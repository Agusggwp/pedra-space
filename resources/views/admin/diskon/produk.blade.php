...
<head>
    ...
    <title>Diskon Produk - POS Admin</title>
                ...
                <div class="p-6 border-b border-gray-200">
                    <form method="GET" class="flex gap-4 items-end">
                        <div class="flex-1">
                            ...
                            <input type="text" name="search" value="{{ request('search') }}" placeholder="Nama atau kode produk..." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                            ...
                            @forelse($diskons as $diskon)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="px-6 py-4 text-sm text-gray-900">
                                        <div class="font-semibold">{{ $diskon->produk->nama }}</div>
                                        <div class="text-xs text-gray-500">{{ $diskon->produk->kode }}</div>
                                    </td>
                                    <td class="px-6 py-4 text-sm text-gray-900">
                                    ...
                                    <td class="px-6 py-4 text-sm">
                                        <div class="flex gap-2">
                                            <a href="{{ route('admin.diskon.produk.edit', $diskon) }}" class="px-3 py-1 bg-blue-600 hover:bg-blue-700 text-white rounded text-xs font-semibold transition-colors">
                                                Edit
                                            </a>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-12 text-center text-gray-500">
                                        ...
                                        <p class="text-lg font-semibold">Tidak ada diskon produk</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
